...
from src.database.db import check_teacher_exists, create_teacher, teacher_login, get_teacher_subject, get_teacher_subject, get_attendance_for_teacher
...
def teacher_dashboard():
    ...
    with c2:
        ...
        if st.button("Go Back To Home", type="secondary", key = "Home", shortcut = "ctrl+backspace"):
    ...
    with tab2:
        ...
        if st.button('Manage Attendance', type=type2, width = "stretch", icon = ':material/book_ribbon:'):
...
def teacher_screen_login():
    ...
    with btnc1:
        if st.button("Login", type="primary", icon = ':material/passkey:', shortcut = "ctrl+enter", width='stretch'):
    ...
    with btnc2:
        if st.button("Register", type="primary", key="teacher_register", icon = ':material/passkey:', shortcut = "ctrl+enter", width='stretch'):
